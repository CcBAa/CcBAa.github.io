...
(function () {
	...
	var langs = {
		en: {
			...
			'whateat.tech.desc': 'Android (Kotlin), RAG Architecture, SQL Server, Vector Database, LLM API, Google Places API',
		...
		zh: {
			...
			'whateat.tech.desc': 'Android (Kotlin), RAG 架構, SQL Server, 向量資料庫, LLM API, Google Places API',
