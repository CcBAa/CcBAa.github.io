...
(function () {
	...
	var langs = {
		en: {
			...
			'about.resume.toast.title': 'Oops! Still cooking...',
			'about.resume.toast.desc': 'My resume is being carefully crafted.<br>Check back soon! 🍳',
		...
		zh: {
			...
			'about.resume': '下載履歷',
			'about.resume.toast.title': '喔喔！還在趕工中...',
			'about.resume.toast.desc': '履歷正在精心製作中，<br>再等等嗎！🛠️',
			'contact.heading': '聯絡',
			'contact.name': '姓名',
			'contact.email': '信箱',
			'contact.message': '訊息',
